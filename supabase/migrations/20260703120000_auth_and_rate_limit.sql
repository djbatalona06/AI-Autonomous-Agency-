-- ============================================================================
-- theWRENCH — Auth + brute-force lockout schema
-- Run this once in your Supabase project (SQL Editor) AFTER the project is
-- un-paused. Idempotent: safe to re-run.
-- ============================================================================
...
-- Table is locked down: RLS on, NO policies => no direct client read/write.
-- Only the SECURITY DEFINER functions below may touch it.
alter table public.login_attempts enable row level security;

-- Returns lockout state: failed attempts in the last 15 min, locked flag,
-- and seconds until the window clears. Threshold = 3 failures / 15 minutes.
...
declare
  ...
  v_fails int; v_oldest timestamptz;
begin
