...
export const N8N_BRAINSTORM: BrainstormEntry[] = [
  ...
  },
  {
    ...
    source: {
      ...
      url: "https://n8n.io/workflows/4508-multi-platform-ai-sales-agent-with-rag-crm-logging-and-appointment-booking/",
    },
    nodeDesign: [
      "Webhook — Website Chat / WhatsApp / Instagram / Facebook",
      "Switch — normalize per-channel payload",
      "Vector Store lookup — product/pricing knowledge base",
      "AI Agent — RAG-grounded answer + booking-intent detection",
      "CRM — upsert contact + log conversation",
      "IF — booking intent detected",
      "Google Calendar / Cal.com — create booking",
      "Reply on originating channel",
    ],
    summary: "No card yet — proposed slot TBD. Every existing SAL card is outbound; this is the first always-on inbound agent, feeding directly into SAL-03's call-prep card once a lead books.",
  ...
  },
  {
    ...
    source: {
      ...
      url: "https://n8n.io/workflows/11805-recover-shopify-abandoned-carts-with-email-sms-whatsapp-and-facebook-retargeting/",
    },
    nodeDesign: [
      "Shopify Webhook — checkout abandoned",
      "Wait — staged delay per touch (1hr/24hr/72hr)",
      "IF — purchased since abandonment?",
      "Switch — touch number",
      "Email + Twilio SMS + WhatsApp — touches 1-2",
      "HTTP Request — Meta Custom Audiences API (retargeting sync), touch 3",
      "Google Sheets — log recovery status + attributed revenue",
    ],
    summary: "Reinforces ECM-01 with a channel no existing ECM card touches — syncing abandoners into a paid-media retargeting audience. Upsell add-on for ECM-01 clients already running Meta ads.",
    dateAdded: "2026-07-31",
  },
  {
    id: "WHL-B11",
    ...
    source: {
      ...
      url: "https://n8n.io/workflows/7250-real-estate-chatbot-with-ai-property-matching-and-automated-calendar-scheduling/",
    },
    nodeDesign: [
      "Chat/Webhook Trigger — inbound buyer inquiry",
      "AI Agent — parse budget/beds/location/investment criteria",
      "HTTP Request — MLS/inventory query",
      "Code — match-score properties against criteria",
      "AI Agent — compose match summary + listing links",
      "Google Calendar — check availability",
      "Calendar booking — auto-schedule showing",
      "CRM — log buyer + matches + booking",
    ],
    summary: "No card yet — proposed slot TBD. Every existing WHL card is seller-side/outbound; this is the first inbound buyer-facing pattern, opening a second product line.",
    dateAdded: "2026-07-31",
  },
  {
    id: "PRD-B11",
    ...
    relatedCardId: "PRD-02",
    source: {
      name: "AI-powered meeting research & daily agenda with Google Calendar, Attio CRM, and Slack",
      url: "https://n8n.io/workflows/7968-ai-powered-meeting-research-and-daily-agenda-with-google-calendar-attio-crm-and-slack/",
    },
    nodeDesign: [
      "Schedule Trigger — early morning",
      "Google Calendar — today's meetings",
      "Loop Over Items — one pass per meeting",
      "HTTP Request — Attio CRM attendee/deal history",
      "AI Agent — synthesize talking points",
      "Aggregate — combine into one daily agenda",
      "Slack — post daily agenda + per-meeting brief",
    ],
    summary: "Reinforces PRD-02's mirror image — that card runs after a meeting (transcript to action items); this runs before, grounded in live CRM history instead of a transcript.",
    dateAdded: "2026-07-31",
  },
  {
    id: "SMB-B11",
    ...
    relatedCardId: "SMB-06",
    source: {
      name: "Smart Customer Support System with GPT-4o, Gmail, Slack & Drive Knowledge Base",
      url: "https://n8n.io/workflows/4543-smart-customer-support-system-with-gpt-4o-gmail-slack-and-drive-knowledge-base/",
    },
    nodeDesign: [
      "Gmail Trigger — poll every minute",
      "Google Drive — sync support docs into a vector store",
      "AI Agent (GPT-4o, RAG) — classify + draft grounded reply",
      "Switch — billing/support/spam/urgent",
      "Gmail — send or draft for review",
      "Slack — escalate urgent/low-confidence to a human",
    ],
    summary: "Reinforces SMB-06 with more depth — grounds every reply in the business's actual synced docs instead of a static template, escalating only what the docs can't answer.",
    dateAdded: "2026-07-31",
  },
];
