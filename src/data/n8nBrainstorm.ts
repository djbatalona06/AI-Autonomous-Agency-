...
export const N8N_BRAINSTORM: BrainstormEntry[] = [
  ...
  },
  {
    ...
    source: {
      ...
      url: "https://n8n.io/workflows/4786-automate-sales-pipeline-builtwith-technology-data-to-trello-lead-cards-with-google-sheets/",
    },
    nodeDesign: [
      "Schedule Trigger",
      "Google Sheets — target domain list",
      "HTTP Request — BuiltWith tech-stack lookup per domain",
      "Code — flag domains missing/using a competing tool (buying signal)",
      "Trello — create lead card with detected stack",
      "Google Sheets — mark processed",
    ],
    summary: "No card yet — proposed SAL-10. Finds buyers by what software they already run (still on a rival CRM, no automation stack) — a colder-outbound signal none of SAL-B01..B10 cover, a fit for SDR-team retainers.",
  ...
  },
  {
    ...
    source: {
      ...
      url: "https://n8n.io/workflows/10008-generate-shopify-product-listings-from-images-with-gemini-ai-and-airtable/",
    },
    nodeDesign: [
      "Google Drive/Airtable Trigger — new product photo uploaded",
      "Gemini (vision) — identify product, draft title/description/tags",
      "Airtable — stage listing for review",
      "IF — approved",
      "Shopify — create product + variants",
      "Slack — notify merchandiser",
    ],
    summary: "No card yet — proposed ECM-10. First listing-creation (content) card in the vertical — every existing ECM card manages an order/customer lifecycle event; this cuts new-SKU setup time instead.",
    dateAdded: "2026-08-07",
  },
  {
    id: "WHL-B15",
    ...
    source: {
      ...
      url: "https://n8n.io/workflows/4872-find-your-home-with-real-estate-agent-and-bright-data/",
    },
    nodeDesign: [
      "Chat Widget/WhatsApp Trigger — buyer inquiry",
      "AI Agent — parse criteria (budget, area, beds/baths, investor vs. owner-occupant)",
      "HTTP Request — Bright Data/MLS listing search",
      "Code — match against cash-buyer buy-box on file",
      "AI Agent — conversational results + follow-up questions",
      "CRM — log buyer + matched listings",
    ],
    summary: "Buyer-facing counterpart to WHL-02's dispo matching — lets cash buyers self-serve a natural-language property search instead of a manual blast list, feeding matches straight into the existing dispo CRM step.",
    dateAdded: "2026-08-07",
  },
  {
    id: "PRD-B15",
    ...
    source: {
      ...
      url: "https://n8n.io/workflows/3414-slack-ai-chatbot-for-business-team-with-rag-claude-37-sonnet-and-google-drive/",
    },
    nodeDesign: [
      "Slack Trigger — @mention or DM",
      "Vector Store retrieval — indexed Google Drive docs (SOPs, policies, past proposals)",
      "AI Agent (Claude) — answer grounded in retrieved docs, cite source doc",
      "IF — no confident match",
      "Slack — reply with answer + source links, or escalate to a human channel",
    ],
    summary: "No card yet — proposed PRD-10. First \"ask the company anything\" card — every existing PRD card automates an inbox/meeting/doc/task/receipt event; this indexes and answers from the team's own knowledge instead.",
    dateAdded: "2026-08-07",
  },
  {
    id: "SMB-B15",
    ...
    source: {
      ...
      url: "https://n8n.io/workflows/8930-streamline-client-onboarding-with-pdf-trello-slack-gmail-and-airtable/",
    },
    nodeDesign: [
      "Webhook — signed contract/deposit received",
      "Airtable — create client record",
      "PDF generation — welcome packet from template",
      "Trello — onboarding checklist board per client",
      "Gmail — send welcome packet + kickoff-call link",
      "Slack — notify assigned account owner",
    ],
    summary: "Picks up where SMB-01's intake booking leaves off — turns a signed deal into a structured onboarding checklist instead of an ad hoc email thread, a natural bundle upsell for any client already on SMB-01.",
    dateAdded: "2026-08-07",
  },
];
