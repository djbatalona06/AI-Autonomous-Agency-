...
export const N8N_BRAINSTORM: BrainstormEntry[] = [
  ...
  },
  {
    ...
    nodeDesign: [
      "Manual/Webhook Trigger — prospect name + company",
      "HTTP Request/Web Search — company site, recent news, LinkedIn",
      "AI Agent — synthesize research brief (news, pain points, tech-stack signals)",
      "Google Sheets — write brief",
      "Gmail — draft personalized opener from the brief",
      "Slack — rep review ping",
    ],
    summary: "Runs before the first cold touch on open-web research (site, news, socials) — not a CRM/LinkedIn lookup after a meeting is already booked.",
  ...
  },
  {
    ...
    newCandidate: true,
    source: {
      name: "Auto-generate problem-focused blog posts for Shopify products with AI",
      url: "https://n8n.io/workflows/5107-auto-generate-problem-focused-blog-posts-for-shopify-products-with-ai/",
    },
    nodeDesign: [
      "Schedule Trigger — weekly",
      "Shopify — Get Many products",
      "Filter — no blog post yet / needs refresh",
      "AI Agent — problem-focused SEO blog draft per product",
      "Shopify/CMS — create draft blog post",
      "Slack — review ping",
    ],
    summary: "First content-marketing/SEO card in ECM — every other card automates a transactional lifecycle step, not top-of-funnel traffic.",
    dateAdded: "2026-08-02",
  },
  {
    id: "WHL-B12",
    ...
    nodeDesign: [
      "Webhook — inbound seller/buyer call or message",
      "AI Agent — classify intent (seller inquiry / buyer negotiation / scheduling)",
      "Switch — seller branch (draft correspondence, log to CRM) / buyer branch (counter-offer talking points, propose times)",
      "Google Calendar — book confirmed slot",
      "CRM — log outcome",
      "Slack — deal-desk notify on any offer/counter",
    ],
    summary: "First WHL card handling live negotiation talking points and dual seller+buyer correspondence via voice, not just text follow-up or property matching.",
    dateAdded: "2026-08-02",
  },
  {
    id: "PRD-B12",
    ...
    nodeDesign: [
      "Google Drive Trigger — new/updated doc in watched folder",
      "Text Splitter + Embeddings (Gemini)",
      "Vector Store (Supabase pgvector) — upsert",
      "Chat Trigger (Slack/webhook question) — separate branch",
      "Vector Store — retrieval",
      "AI Agent — answer grounded in retrieved chunks, cites source doc",
      "Slack — reply in thread",
    ],
    summary: "General cross-doc-type (PDFs, Docs, Sheets) knowledge assistant — distinct from PRD-B08's Notion-only task/content MCP assistant.",
    dateAdded: "2026-08-02",
  },
  {
    id: "SMB-B12",
    ...
    nodeDesign: [
      "Webhook/Form — job or order marked billable",
      "AI Agent — draft line items from job notes",
      "PDF generation — invoice template",
      "Gmail — send to customer",
      "Google Sheets/Airtable — log invoice, status = sent",
      "Schedule Trigger — daily status poll",
      "IF — marked paid in accounting tool — update status",
    ],
    summary: "The front half SMB-02 doesn't cover — drafting and issuing the invoice from raw job notes, not just chasing an already-unpaid one. Sell as a pair.",
    dateAdded: "2026-08-02",
  },
];
