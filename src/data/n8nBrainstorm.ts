...
export const N8N_BRAINSTORM: BrainstormEntry[] = [
  ...
  },
  {
    ...
    relatedCardId: "SAL-B08",
    newCandidate: true,
    source: {
      name: "Track and analyze sales performance with AI insights and Google Sheets",
      url: "https://n8n.io/workflows/5975-track-and-analyze-sales-performance-with-ai-insights-and-google-sheets/",
    },
    nodeDesign: [
      "Schedule Trigger — daily",
      "HTTP Request — CRM + telephony/email log pull (calls, emails, meetings, quota attainment per rep)",
      "Code — aggregate activity metrics per rep",
      "AI Agent — analyze patterns, surface coaching tips + quota-risk flags",
      "Google Sheets — write rep scorecard",
      "Slack — weekly manager digest",
    ],
    summary: "Manager-facing rep coaching tool, not a deal-level alert — SAL-B08 flags individual stalled deals; this scores rep activity/quota trends over time and surfaces coaching guidance.",
  ...
  },
  {
    ...
    relatedCardId: "ECM-B06",
    newCandidate: true,
    source: {
      name: "E-commerce assistant for Shopify & WooCommerce with GPT-4o, Gemini & RAG",
      url: "https://n8n.io/workflows/6100-e-commerce-assistant-for-shopify-and-woocommerce-with-gpt-4o-gemini-and-rag/",
    },
    nodeDesign: [
      "Chat Widget/Webhook Trigger — either platform",
      "Switch — route by store platform (Shopify vs. WooCommerce)",
      "Vector Store retrieval — product catalog + policy docs (RAG)",
      "Shopify/WooCommerce node — live order-status lookup",
      "AI Agent (GPT-4o/Gemini) — answer grounded in catalog docs + live order data",
      "IF — needs human (refund/complaint) → Slack/Zendesk escalate",
    ],
    summary: "Reinforces ECM-B06's order-memory chatbot with a platform-agnostic RAG layer (catalog/policy docs, not just order history) and native WooCommerce support alongside Shopify — a fit for merchants running both.",
    dateAdded: "2026-08-06",
  },
  {
    id: "WHL-B14",
    ...
    source: {
      ...
      url: "https://n8n.io/workflows/5220-automated-property-market-reports-with-bright-data-and-n8n/",
    },
    nodeDesign: [
      "Schedule Trigger — weekly, per target market/zip",
      "HTTP Request — Bright Data (comps, days-on-market, price trends scrape)",
      "AI Agent — synthesize market-trend narrative + investment-angle summary",
      "PDF/Doc generation — branded market report",
      "Gmail — send to seller leads/investor list",
      "Google Sheets — log report + open/click tracking",
    ],
    summary: "First WHL card built for content/authority marketing rather than lead intake or qualification — a recurring seller/investor-facing report that doubles as a warm-lead nurture touch, distinct from every existing WHL card's transactional focus.",
    dateAdded: "2026-08-06",
  },
  {
    id: "PRD-B14",
    ...
    source: {
      ...
      url: "https://n8n.io/workflows/8393-automate-receipt-processing-for-expense-tracking-with-google-drive-vlm-run-and-airtable/",
    },
    nodeDesign: [
      "Google Drive Trigger — new receipt image/PDF in watched folder",
      "VLM Run (vision model) — extract vendor, date, line items, total",
      "Code — categorize by expense type",
      "Airtable — log expense record",
      "IF — over threshold → Slack approval ping",
      "Schedule Trigger — monthly summary report to Sheets",
    ],
    summary: "First back-office/finance-ops card in PRD — every existing card automates inbox, meetings, or docs; this is the first expense/receipt pipeline, a clean Ops Retainer add-on (low hourly footprint, recurring value).",
    dateAdded: "2026-08-06",
  },
  {
    id: "SMB-B14",
    ...
    source: {
      ...
      url: "https://n8n.io/workflows/8635-complete-booking-system-with-google-calendar-business-hours-and-rest-api/",
    },
    nodeDesign: [
      "Webhook (REST API) — availability query / booking request from any front-end",
      "Code — apply business-hours + buffer-time rules",
      "Google Calendar — check conflicts",
      "IF — slot available",
      "Google Calendar — create event",
      "Webhook Response — confirmation payload back to caller",
    ],
    summary: "Infrastructure layer, not a messaging layer — SMB-01 confirms an intake booking and SMB-05 chases no-shows; this is the underlying booking backend/API a client without any calendar tooling can build a custom intake form on top of.",
    dateAdded: "2026-08-06",
  },
];
